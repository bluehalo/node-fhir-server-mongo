...
let getCompartmentDefinition = base_version => {
  return require(resolveSchema(base_version, 'CompartmentDefinition'));
};
...
module.exports.update = (args, { req }) =>
  new Promise((resolve, reject) => {
    ...
    resolve({
      id: compartmentdefinition_resource.id,
      created: false,
      resource_version: compartmentdefinition_resource.meta.versionId,
    });
  });
