...
module.exports = {
    ...
    ActivityDefinition: {
        ...
        specimenRequirement: async (parent, args, context, info) => {
            return await findResourcesByReference(parent.specimenRequirement);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        observationRequirement: async (parent, args, context, info) => {
            return await findResourcesByReference(parent.observationRequirement);
        },
        // noinspection JSUnusedLocalSymbols
        // eslint-disable-next-line no-unused-vars
        observationResultRequirement: async (parent, args, context, info) => {
            return await findResourcesByReference(parent.observationResultRequirement);
        },
    }
};
